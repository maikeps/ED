...
#include "../Exceptions/EstruturaVazia.h"
#include "../Exceptions/EstruturaCheia.h"
#include "../Exceptions/PosicaoInvalida.h"
#include "../Exceptions/DadoNaoEncontradoException.h"
#include <iostream>
